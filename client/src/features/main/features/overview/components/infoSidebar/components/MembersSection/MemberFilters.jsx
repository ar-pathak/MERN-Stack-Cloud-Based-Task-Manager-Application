        ...
        <div className="space-y-4">
                ...
                {Object.entries(roleStats).map(([role, count]) => {
                    ...
                    return (
                        <motion.button
                            ...
                            className={`flex items-center gap-2 px-3.5 py-2 rounded-lg font-medium text-xs transition-all border ${isActive ? "bg-slate-700 border-sky-500/50 text-sky-400" : "bg-slate-800/50 border-slate-700/50 text-slate-400"}`}
                        >
            ...
            <div className="relative w-full">
                ...
                <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-slate-800/50 border border-slate-700 rounded-xl text-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-sky-500/50"
                />
                {searchQuery && (
