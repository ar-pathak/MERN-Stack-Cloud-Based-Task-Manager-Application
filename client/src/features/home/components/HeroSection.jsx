  ...
  return (
    <section className="mx-auto flex w-full max-w-7xl flex-col gap-10 px-3 pb-14 pt-6 sm:px-6 sm:pt-8 lg:flex-row lg:items-center lg:py-16 lg:px-8">
      <div className="flex-1">
        <p className="inline-flex max-w-full items-center gap-2 rounded-full bg-slate-900/70 px-3 py-1 text-[11px] font-medium text-slate-200 ring-1 ring-slate-700/70 backdrop-blur sm:text-xs">
        ...
        <h1 className="mt-5 text-2xl font-semibold leading-tight tracking-tight text-slate-50 sm:text-4xl lg:text-5xl">
        ...
        <p className="mt-4 max-w-xl text-[13px] leading-relaxed text-slate-300 sm:text-base">
          Build workspaces, organize projects and tasks, collaborate in real time, and review
          analytics without jumping between disconnected tools. Aurora reflects the exact flow your
          team uses inside the app.
        </p>
      ...
      <div className="relative mt-8 flex-1 lg:mt-0">
        <div className="absolute inset-0 -translate-x-4 -translate-y-4 rounded-[30px] bg-gradient-to-br from-cyan-500/25 via-sky-500/15 to-transparent blur-xl" />
        ...
        <div className="relative rounded-[24px] border border-slate-700/80 bg-slate-900/80 p-3 shadow-2xl shadow-sky-950/40 backdrop-blur sm:rounded-[28px] sm:p-4">
          <div className="flex flex-wrap items-start justify-between gap-2.5">
            <div className="min-w-0">
              <p className="text-xs uppercase tracking-[0.18em] text-slate-400">Aurora Workspace</p>
          ...
          <div className="mt-4 grid gap-3 md:grid-cols-2">
            <div className="rounded-2xl border border-slate-800/70 bg-slate-950/60 p-3">
              <p className="text-[11px] uppercase tracking-[0.14em] text-cyan-300">Aurora Flow</p>
              <ul className="mt-2 space-y-2 text-xs text-slate-300">
                <li className="rounded-xl bg-slate-900/70 px-2.5 py-2 break-words">
                ...
                <li className="rounded-xl bg-slate-900/70 px-2.5 py-2 break-words">
                  Ship Q1 release notes
                </li>
              </ul>
            </div>

            <div className="rounded-2xl border border-slate-800/70 bg-slate-950/60 p-3">
              <p className="text-[11px] uppercase tracking-[0.14em] text-sky-300">Aurora Connect</p>
